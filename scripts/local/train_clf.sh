...
RANDOM_SEED=0 \
#  printf "allennlp train ./configs/classifiers/${CONFIG_NAME}.jsonnet --serialization-dir ./experiments/trained_models/${DATASET_NAME}/${CLF_TYPE}_clf/${CONFIG_NAME} --include-package advsber \n" 
printf "${CLF_TRAIN_DATA_PATH}\n"
printf "${CLF_VALID_DATA_PATH}\n"
printf "${VOCAB_PATH}\n"
printf "${CLF_TEST_DATA_PATH}\n"
