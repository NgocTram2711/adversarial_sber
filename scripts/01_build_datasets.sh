...
PYTHONPATH=. python python_scripts/create_gender_short.py
...
PYTHONPATH=. python python_scripts/create_age_short.py
...
PYTHONPATH=. python python_scripts/create_age_tinkoff.py
...
PYTHONPATH=. python python_scripts/create_gender_tinkoff.py
...
PYTHONPATH=. python python_scripts/create_rosbank.py
